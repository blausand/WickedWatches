...
import net.blausand.wickedwatch.helpers.IcyDataSourceFactory;
import net.blausand.wickedwatch.helpers.LogHelper;
import net.blausand.wickedwatch.helpers.NotificationHelper;
import net.blausand.wickedwatch.helpers.PackageValidator;
import net.blausand.wickedwatch.helpers.PlayerCallback;
import net.blausand.wickedwatch.helpers.StationListProvider;
...
import static net.blausand.wickedwatch.helpers.StationListProvider.MEDIA_ID_EMPTY_ROOT;
import static net.blausand.wickedwatch.helpers.StationListProvider.MEDIA_ID_ROOT;
...
//                        result.sendResult(Collections.<MediaBrowserCompat.MediaItem>emptyList());
    ...
    private void create2ndPlayer() {
        ...
        // create the player
        mPlayer2 = ExoPlayerFactory.newSimpleInstance(new DefaultRenderersFactory(getApplicationContext()), trackSelector, loadControl);
    }
...
//MNB copy this to bring ICECAST and AsyncTask into W&W at the same time. DONT mix up AsyncTask and Service! Learn how to migrate exoplayer_codelab to running as Service first.
