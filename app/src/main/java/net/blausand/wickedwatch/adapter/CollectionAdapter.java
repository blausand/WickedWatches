...
package net.blausand.wickedwatch.adapter;
...
import net.blausand.wickedwatch.helpers.DialogAdd;
...
import net.blausand.wickedwatch.helpers.StorageHelper;
...
public final class CollectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements TransistorKeys {
    ...
    /* Handles a playback state error that can occur when Wickedwatch crashes during playback */
    private void handlePlaybackStateError(Intent intent) {
        LogHelper.e(LOG_TAG, "Forcing a reload of station list. Did Wickedwatch crash?");
