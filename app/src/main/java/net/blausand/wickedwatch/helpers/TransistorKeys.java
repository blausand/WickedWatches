...
public interface TransistorKeys {
    ...
    String APPLICATION_NAME = "Wicked Watch";

    /* ACTIONS */
    String ACTION_PLAY = "net.blausand.wickedwatch.action.PLAY";
    String ACTION_STOP = "net.blausand.wickedwatch.action.STOP";
    String ACTION_DISMISS = "net.blausand.wickedwatch.action.DISMISS";
    String ACTION_PLAYBACK_STATE_CHANGED = "net.blausand.wickedwatch.action.PLAYBACK_STATE_CHANGED";
    String ACTION_METADATA_CHANGED = "net.blausand.wickedwatch.action.METADATA_CHANGED";
    String ACTION_SHOW_PLAYER = "net.blausand.wickedwatch.action.SHOW_PLAYER";
    ...
    String SELECT_STREAM_KEY_NAME = "SELECT_STREAM_KEY_NAME";
    String SELECT_STREAM_KEY_URL = "SELECT_STREAM_KEY_URL";
